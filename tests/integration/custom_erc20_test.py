...
async def setup_state():
    ...
    l1_token, l2_token = await register_custom_token(
        setup.l2_network, setup.l1_signer, setup.l2_signer, setup.admin_erc20_bridger
    )
...
async def test_withdraws_erc20(setup_state):
    l2_token_addr = await setup_state.admin_erc20_bridger.get_l2_erc20_address(
        setup_state.l1_custom_token.address, setup_state.l1_signer.provider
    )
    l2_token = setup_state.admin_erc20_bridger.get_l2_token_contract(setup_state.l2_signer.provider, l2_token_addr)
