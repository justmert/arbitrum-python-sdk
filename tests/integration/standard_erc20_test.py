...
async def setup_state():
    ...
    contract = deploy_test_erc20(setup.l1_signer.provider, setup.l1_signer.account)
    print("deployed_erc20_address", contract)

    # # Mint tokens
    mint_receipt = mint_tokens(setup.l1_signer.provider, contract, setup.l1_signer.account)
